                ...
                <div className="flex items-center mx-auto w-fit group">
                    ...
                    {onDelete && (
                        <button
                            ...
                            className="ml-2 p-1 rounded-full hover:bg-gray-200 transition-colors flex items-center justify-center text-gray-500 text-base h-6 w-6 opacity-0 group-hover:opacity-100"
