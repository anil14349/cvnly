...
export const SECTION_ADD_BUTTON_BASE = 'add-section-btn flex items-center px-3 py-1.5 rounded hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors bg-transparent print:hidden';

// Button styles object pattern (for consistency)
export const SECTION_BUTTON_STYLES = {
    button: SECTION_ADD_BUTTON_BASE,
